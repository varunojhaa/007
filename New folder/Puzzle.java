...
class Puzzle {
    ...
    public static void main(String args[]){
        String str="807465132"; // Input the Board State as a String with 0 as the Blank Space
        Puzzle e = new Puzzle(); // New Instance of the EightPuzzlea
...
private void checkCompletion(String oldState, String newState) {
    ...
    if(newState.equals("123456780")) {
        System.out.println("Solution Exists at "+stateDepth.get(newState)+" Step");
        String traceState = newState;
        while (traceState != null) {
            System.out.println(traceState + " at " + stateDepth.get(traceState)+" Step");
